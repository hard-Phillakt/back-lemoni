...
namespace app\widget\customcart\controllers;
...
//              $elementModel = $cart->putWithPrice($productModel, $productModel->lm_price_for_kg, $postData['CartElement']['count'], $options);
            } else {
