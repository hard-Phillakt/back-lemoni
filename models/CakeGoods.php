...
class CakeGoods extends \yii\db\ActiveRecord implements \dvizh\cart\interfaces\CartElement {
    ...
    {
        return [
            [['lm_essence', 'lm_title', 'lm_description', 'lm_content', 'lm_weight', 'lm_price_for_kg', 'lm_type', 'lm_count_level', 'lm_subjects', 'lm_create_box', 'lm_publicate', 'lm_prioritet', 'lm_img_one', 'lm_img_two', 'lm_img_three', 'lm_compilation', 'lm_alter_card'], 'required'],
