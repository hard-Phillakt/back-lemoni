...
/**
 * This is the model class for table "candie_goods".
 *
 * @property int $id
 ...
 */
class CandieGoods extends \yii\db\ActiveRecord implements \dvizh\cart\interfaces\CartElement {
...
//                'variants' => ['descriptions-10-nadpis' => '',]
    ...
    {
        return [
            [['lm_essence', 'lm_title',  'lm_content', 'lm_price_for_kg', 'lm_type', 'lm_count_level', 'lm_create_box', 'lm_publicate', 'lm_prioritet', 'lm_img_one', 'lm_alter_card'], 'required'],
