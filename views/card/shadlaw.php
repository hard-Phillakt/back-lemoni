        ...
        <div class="row">
            <div class="col-lg-12">
                <a href="<?= Url::home(); ?>" class="breadcrumbs-line__active">Главная</a> <span>-</span> <a
                    href="<?= Url::to('/cake'); ?>" class="breadcrumbs-line__active">Торты</a>
            ...
            <div class="col-lg-5 col-lg-offset-1 col-md-5 col-md-offset-1 col-sm-5 col-sm-offset-1 col-xs-12 mt-35">
                ...
                <div class="mt-15">
                    <p class="desc desc__sm opac__05">
                        *Стандартный срок изготовления нашей продукции от 2-х дней.
                        Муссовые изделия вы сможете получить уже через 4 часа.
                        Точные сроки изготовления, а так же наличие товаров и их аналогов, вы можете уточнить у нашего менеджера при оформлении заказа.
                    </p>
                </div>
